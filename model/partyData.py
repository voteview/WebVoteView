...
def getPartyName(code):
	...
	r = db.voteview_parties.find_one({"id": code},{"partyname": 1, "count": 1, "fullName": 1, "pluralNoun": 1, "noun": 1, "_id": 0})
	if not r or r is None or not "partyname" in r:
		return {"error": "Party code not found.", "partyname": null}
	else:
		return {"partyname": r["partyname"], "fullName": r["fullName"], "pluralNoun": r["pluralNoun"], "noun": r["noun"]}
