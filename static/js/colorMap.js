const partyMapping = {
	...
	"Silver": "Democrat",
	...(congressNum == 24 ? {"States Rights": "Nullifier"} : {}),
	...(congressNum == 34 ? {"Republican": "Opposition"} : {})
}
...
// ColorBrewer Diverging Colors.
// Yea: 5-class, most intense;
// Nay: 5-class, second intensity.
// Abs: 7-class 3rd intensity, blended with #f7f7f7
// Yellow: From YellowOrangeRed.
// Yea: 5-class 2nd yellow;
// Nay: 5-class 1st yellow;
// Abs: 7-class 1st yellow, blended with #f7f7f7
const colorSchemes = {
...
// ColorBrewer single-hue sequential, 6-class
// (7th class will always be white and added externally)
const colorSchemesSequential = {
	"red": ["#a50f15", "#de2d26", "#fb6a4a", "#fc9272", "#fcbba1", "#fee5d9"],
	"orange": ["#a63603", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#feedde"],
	// Yellow is manual gradient, not one of ColorBrewer's
	"yellow": ["#ffff00", "#ffff2a", "#ffff55", "#ffff7f", "#ffffaa", "#ffffd4"],
	"green": ["#006d2c", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#edf8e9"],
	// Teal is PuBuGn 6-class sequential
	"teal": ["#016c59", "#1c9099", "#67a9cf", "#a6bddb", "#d0d1e6", "#f6eff7"],
	...
	// brown is YlOrBr 6-class sequential
	"brown": ["#993404", "#d95f0e", "#fe9929", "#fec44f", "#fee391", "#ffffd4"],
}
...
{
	let r = 0, g = 0 , b = 0, i, rgbColor;
	for (i = 0; i < members.length; i++)
	{
		if(members[i].vote != undefined & voteShade == true)
		{
			rgbColor = d3.rgb(
				partyColors[members[i].vote + partyNameSimplify(members[i].party_short_name)]
			);
		} else {
			rgbColor = d3.rgb(
				partyColors["Yea"+partyNameSimplify(members[i].party_short_name)]
			);
...
const partyColors = genPartyColors();
