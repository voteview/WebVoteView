...
dc.coordinateGridMixin = function (_chart) {
    ...
    _chart.renderBrush = function (g) {
	    ...
	    /* JBL: These two lines have to do with making zoom and brush
	            play nicely. However, even with zoom turned off
		    calling these zoom functions leaves some traces that
		    keep scrolling from happening when the mouse is over
		    the scatter plot.  Commenting the lines out fixes this
		    problem and works for us because we do not allow zooming
		    of the scatterplots in any case */
